...
export default async function BroodmaresPage() {
  ...
  const roster: RosterHorse[] = horses.map((h) => ({
    id: h.id, name: h.name, breed: h.breed, coat: h.coat, gender: "Mare",
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-10">
      ...
      <RosterGrid horses={roster} emptyLabel="No broodmares are currently listed." hrefPrefix="/breeding/broodmares" />
    </main>
  );
}
