...
export default async function StudsPage() {
  ...
  const roster: RosterHorse[] = horses.map((h) => ({
    id: h.id, name: h.name, breed: h.breed, coat: h.coat, gender: "Stallion",
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-10">
      ...
      <RosterGrid horses={roster} emptyLabel="No stallions are currently listed at stud." hrefPrefix="/breeding/studs" />
    </main>
  );
}
