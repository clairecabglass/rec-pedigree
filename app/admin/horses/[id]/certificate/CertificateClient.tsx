    ...
    <div className="max-w-6xl mx-auto px-6 py-10">
      ...
      <div style={{ position: "fixed", left: -99999, top: 0, pointerEvents: "none" }} aria-hidden>
        <div ref={certRef} style={{ width: CERT_W, height: CERT_H, position: "relative", background: "#EEF1ED" }}>
          ...
          {/* Registration number */}
          {regNumber && (
            <div style={{ position: "absolute", top: "12.6%", left: "68%", width: "24%", textAlign: "center", fontFamily: "var(--font-lato), sans-serif", fontSize: 18, color: "var(--teal-dark)", letterSpacing: "0.05em" }}>
              {regNumber}
            </div>
          )}
