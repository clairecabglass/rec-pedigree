...
*   **Breed:** In pedigree cells that show two lines of text, the FIRST line is the full horse name and the SECOND line is the breed.
*   **CRITICAL — Stable/Registry Tags:** Horse names in this registry include a bracketed prefix such as [REC], [TAB], [SPC], [OSR], [OSS], [GLO], etc. These tags are an INSEPARABLE part of the horse's full name. You MUST preserve the full bracket tag in the name field. For example: a cell showing "[SPC] Globe Thistle" on line one and "Anglo-Arabian" on line two → name = "[SPC] Globe Thistle", breed = "Anglo-Arabian". NEVER strip or separate the bracket prefix from the rest of the name.
